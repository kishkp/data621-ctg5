...
\
\
###Following is the summary of the train data set
\
...
### % break up of target variable in train data set
...
```{r, echo = FALSE, warning=FALSE, message=FALSE}
ds_stats <- psych::describe(city_crime_train, skew = FALSE, na.rm = TRUE)
ds_stats
...
#### Notes: Similar explanation of model co efficient will be applicable here as described for model 1 & 2 and is not repreated here.
