...
```{r model 2 performance,echo=FALSE,eval=FALSE}
...
#AUC
#pred <- prediction(df_pre_train1_step, train_test$target)
perf <- performance(pred, measure = "tpr", x.measure = "fpr")
...
```{r model 3 performance,echo=FALSE,eval=FALSE}
...
#AUC
pred <- prediction(df_pre_train2, train_test_mod$target)
perf <- performance(pred, measure = "tpr", x.measure = "fpr")
