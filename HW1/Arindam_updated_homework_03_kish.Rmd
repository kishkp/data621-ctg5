...
## Model diagnostics plots to validate the assumption of Linear Regression:

Plot for normality of residual values:
...
```{r model diagnostics III,echo=FALSE,eval=FALSE}
