...
```{r, echo = FALSE, warning=FALSE, message=FALSE}
 ...
 plot(jitter(moneyball2$TEAM_BATTING_H),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BATTING_H ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BATTING_H,main="TEAM_BATTING_H")
 

 boxplot(moneyball2$TEAM_BATTING_2B,main="TEAM_BATTING_2B")
 plot(jitter(moneyball2$TEAM_BATTING_2B),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BATTING_2B ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BATTING_2B,main="TEAM_BATTING_2B")
 
 par(mfrow=c(2,3))
 boxplot(moneyball2$TEAM_BATTING_3B,main="TEAM_BATTING_3B")
 plot(jitter(moneyball2$TEAM_BATTING_3B),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BATTING_3B ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BATTING_3B,main="TEAM_BATTING_3B")
 

 boxplot(moneyball2$TEAM_BATTING_HR,main="TEAM_BATTING_HR")
 plot(jitter(moneyball2$TEAM_BATTING_HR),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BATTING_HR ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BATTING_HR,main="TEAM_BATTING_HR")
 
 par(mfrow=c(2,3))
 boxplot(moneyball2$TEAM_BATTING_BB,main="TEAM_BATTING_BB")
 plot(jitter(moneyball2$TEAM_BATTING_BB),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BATTING_BB ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BATTING_BB,main="TEAM_BATTING_BB")
 
 
 boxplot(moneyball2$TEAM_BATTING_HBP,main="TEAM_BATTING_HBP")
 plot(jitter(moneyball2$TEAM_BATTING_HBP),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BATTING_HBP ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BATTING_HBP,main="TEAM_BATTING_HBP")

 
 par(mfrow=c(2,3))
 boxplot(moneyball2$TEAM_BATTING_SO,main="TEAM_BATTING_SO")
 plot(jitter(moneyball2$TEAM_BATTING_SO),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BATTING_SO ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BATTING_SO,main="TEAM_BATTING_SO")
 

 
 boxplot(moneyball2$TEAM_BASERUN_SB,main="TEAM_BASERUN_SB")
 plot(jitter(moneyball2$TEAM_BASERUN_SB),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BASERUN_SB ", 
      ylab="TARGET_WINS",main="BATTING_H vs. WINS")
 hist(moneyball2$TEAM_BASERUN_SB,main="TEAM_BASERUN_SB")
 
 
 
 par(mfrow=c(2,3))
 boxplot(moneyball2$TEAM_FIELDING_E,main="TEAM_FIELDING_E")
 plot(jitter(moneyball2$TEAM_FIELDING_E),jitter(moneyball2$TARGET_WINS),xlab="TEAM_FIELDING_E ", 
      ylab="TARGET_WINS",main="TEAM_FIELDING_E vs. WINS")
 hist(moneyball2$TEAM_FIELDING_E,main="TEAM_FIELDING_E")
 
  boxplot(moneyball2$TEAM_BASERUN_CS,main="TEAM_BASERUN_CS")
 plot(jitter(moneyball2$TEAM_BASERUN_CS),jitter(moneyball2$TARGET_WINS),xlab="TEAM_BASERUN_CS ", 
      ylab="TARGET_WINS",main="TEAM_BASERUN_CS vs. WINS")
 hist(moneyball2$TEAM_BASERUN_CS,main="TEAM_BASERUN_CS")



 par(mfrow=c(2,3))
 boxplot(moneyball2$TEAM_FIELDING_DP,main="TEAM_FIELDING_DP")
 plot(jitter(moneyball2$TEAM_FIELDING_DP),jitter(moneyball2$TARGET_WINS),xlab="TEAM_FIELDING_DP ", 
      ylab="TARGET_WINS",main="TEAM_FIELDING_DP vs. WINS")
 hist(moneyball2$TEAM_FIELDING_DP,main="TEAM_FIELDING_DP")


 boxplot(moneyball2$TEAM_PITCHING_BB,main="TEAM_PITCHING_BB")
 plot(jitter(moneyball2$TEAM_PITCHING_BB),jitter(moneyball2$TARGET_WINS),xlab="TEAM_PITCHING_BB ", 
      ylab="TARGET_WINS",main="TEAM_PITCHING_BB vs. WINS")
 hist(moneyball2$TEAM_PITCHING_BB,main="TEAM_PITCHING_BB")


 par(mfrow=c(2,3))
 boxplot(moneyball2$TEAM_PITCHING_H,main="TEAM_PITCHING_H")
 plot(jitter(moneyball2$TEAM_PITCHING_H),jitter(moneyball2$TARGET_WINS),xlab="TEAM_PITCHING_H ", 
      ylab="TARGET_WINS",main="TEAM_PITCHING_H vs. WINS")
 hist(moneyball2$TEAM_PITCHING_H,main="TEAM_PITCHING_H")

  boxplot(moneyball2$TEAM_PITCHING_HR,main="TEAM_PITCHING_HR")
 plot(jitter(moneyball2$TEAM_PITCHING_HR),jitter(moneyball2$TARGET_WINS),xlab="TEAM_PITCHING_HR ", 
      ylab="TARGET_WINS",main="TEAM_PITCHING_HR vs. WINS")
 hist(moneyball2$TEAM_PITCHING_HR,main="TEAM_PITCHING_HR")
 ...
 plot(jitter(moneyball2$TEAM_PITCHING_SO),jitter(moneyball2$TARGET_WINS),xlab="TEAM_PITCHING_SO ", 
      ylab="TARGET_WINS",main="TEAM_PITCHING_SO vs. WINS")
 hist(moneyball2$TEAM_PITCHING_SO,main="TEAM_PITCHING_SO")
