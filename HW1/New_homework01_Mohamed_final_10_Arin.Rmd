...
Looking at the AIC values it appears that models, "step1" & "step 4" are comparatively better models of the pack.  "step1" has adjusted R^2 value 0.4019  which means this model can explain 40.19% variability in data. "step4" has adjusted R^2 value of 0.4197 and this model can explain 41.97% variability in data. From this two data points model "step4" was picked for further evaluation.
