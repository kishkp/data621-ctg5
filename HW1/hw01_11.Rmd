...
```{r, echo = TRUE, warning=FALSE, message=FALSE}
par (mfrow=c(2,2))
regH <- lm(TEAM_BATTING_H~TEAM_PITCHING_H, data = moneyball2)
plot(moneyball2$TEAM_BATTING_H, moneyball2$TEAM_PITCHING_H)
abline(regH, col="red")
cor(moneyball2$TEAM_BATTING_H, moneyball2$TEAM_PITCHING_H)

regBB <- lm(TEAM_BATTING_BB~TEAM_PITCHING_BB, data=moneyball2)
plot(moneyball2$TEAM_BATTING_BB, moneyball2$TEAM_PITCHING_BB)
abline(regBB, col="red")
cor(moneyball2$TEAM_BATTING_BB, moneyball2$TEAM_PITCHING_BB)
   
regHR <- lm(TEAM_BATTING_HR~TEAM_PITCHING_HR, data= moneyball2)
plot(moneyball2$TEAM_BATTING_HR, moneyball2$TEAM_PITCHING_HR)
abline(regHR, col="red")
cor(moneyball2$TEAM_BATTING_HR, moneyball2$TEAM_PITCHING_HR)

regSO <- lm(TEAM_BATTING_SO~TEAM_PITCHING_SO , data=moneyball2)
plot(moneyball2$TEAM_BATTING_SO, moneyball2$TEAM_PITCHING_SO)
abline(regSO, col="red")
cor(moneyball2$TEAM_BATTING_SO, moneyball2$TEAM_PITCHING_SO)

# Avg scores per game (total of 162 games played)
moneyball2$AVG_TEAM_BATTING_H  = moneyball2$TEAM_BATTING_H / 162
moneyball2$AVG_TEAM_BATTING_2B = moneyball2$TEAM_BATTING_2B / 162
moneyball2$AVG_TEAM_BATTING_3B = moneyball2$TEAM_BATTING_3B / 162
moneyball2$AVG_TEAM_BATTING_HR = moneyball2$TEAM_BATTING_HR / 162
moneyball2$AVG_TEAM_BATTING_BB = moneyball2$TEAM_BATTING_BB / 162
moneyball2$AVG_TEAM_BASERUN_SB = moneyball2$TEAM_BASERUN_SB / 162
moneyball2$AVG_TEAM_FIELDING_E = moneyball2$TEAM_FIELDING_E / 162
moneyball2$AVG_TEAM_PITCHING_BB = moneyball2$TEAM_PITCHING_BB / 162
moneyball2$AVG_TEAM_PITCHING_H  = moneyball2$TEAM_PITCHING_H / 162
moneyball2$AVG_TEAM_PITCHING_HR = moneyball2$TEAM_PITCHING_HR / 162
moneyball2$AVG_TEAM_BASERUN_SB  = moneyball2$TEAM_BASERUN_SB / 162
