...
\
\
TEAM_FIELDING_DP (-0.12) and TEAM_PITCHING_SO ( -0.031) have a negative coefficient even though they are theoretically supposed to have a positive impact on wins. This means that a unit change in each of these variables will decrease the number of a wins. 
\
Similarly, TEAM_PITCHING_BB (0.057) and TEAM_PITCHING_HR (0.090) have a positive coefficient even though they are theoretically supposed to have a negative impact on wins. This means that a unit change in each of these variables will increase the number of a wins. 
\
TEAM_BATTING_H (0.025), TEAM_BATTING_HBP (0.087) and TEAM_FIELDING_E (-0.17) have the intended theoretical impact on wins. This means that a unit change in each of these variables will either decrease or increase the number of a wins as intended by the theoretical impact. 
\
\
...
\
\
TEAM_BATTING_3B (-0.12), TEAM_FIELDING_DP ( -0.112) and TEAM_PITCHING_SO (-0.028) have a negative coefficient even though they are theoretically supposed to have a positive impact on wins. This means that a unit change in each of these variables will decrease the number of a wins. 

\
Similarly, TEAM_PITCHING_H (0.031) and TEAM_PITCHING_HR (0.081) have a positive coefficient even though they are theoretically supposed to have a negative impact on wins. This means that a unit change in each of these variables will increase the number of a wins. 

\
TEAM_BATTING_BB (0.055) and TEAM_FIELDING_E (-0.174) have the intended theoretical impact on wins. This means that a unit change in each of these variables will either decrease or increase the number of a wins as intended by the theoretical impact. 
...
\
\
TEAM_BATTING_BB (-2.00) and TEAM_BASERUN_SB ( -2.20) have a negative coefficient even though they are theoretically supposed to have a positive impact on wins.This means that a unit change in each of these variables will decrease the number of a wins. 

\
TEAM_FIELDING_DP (2.40), TEAM_PITCHING_HR (-1.78), TEAM_BATTING_EB (0.102) and TEAM_BATTING_1B (0.044) have the intended theoretical impact on wins. This means that a unit change in each of these variables will either decrease or increase the number of a wins as intended by the theoretical impact. 

\
\

The newly derived variables, Walks_R (-5393.06) and HomeRuns_R (4971.97) seem to have a huge impact on the wins. A unit change in each of these variables seems to have a huge impact on the wins.
\
\
...
\
\
TEAM_FIELDING_DP (-0.107), TEAM_BATTING_BB_SIN (-1.47) and TEAM_BASERUN_SB_SIN(-2.44) have a negative coefficient even though they are theoretically supposed to have a positive impact on wins. This means that a unit change in each of these variables will decrease the number of a wins. 

\

TEAM_PITCHING_HR (0.083) has a positive coefficient even though they are theoretically supposed to have a negative impact on wins. This means that a unit change in each of these variables will increase the number of a wins. 
\

TEAM_BATTING_H (0.017), TEAM_BATTING_BB (8.604), TEAM_BATTING_SO (-6.535), TEAM_BATTING_HBP (0.095), TEAM_PITCHING_BB (-8.551), TEAM_PITCHING_SO (6.5), TEAM_FIELDING_E (-0.181), TEAM_FIELDING_DP_SIN (1.897), Walks_R (-14747.74), HomeRuns_R (4845.243), Strikeout_R (11798.72) have the intended theoretical impact on wins. This means that a unit change in each of these variables will either decrease or increase the number of a wins as intended by the theoretical impact. 

\
\

The newly derived variables, Walks_R (-14747.74), HomeRuns_R (4845.243) and Strikeout_R (11798.72) seem to have a huge impact on the wins. A unit change in each of these variables seems to have a huge impact on the wins.
\
\
...
pred_test <- predict(step4_final, moneyballTest, interval="prediction", level=0.95)
