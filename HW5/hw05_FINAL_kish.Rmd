...
```{r}
#modselect<- read.csv("C:/CUNY/Courses/IS621/Assignment602/Assignment05/Sat/modelselection2.csv")
...
```{r}
#modselect<- read.csv("C:/CUNY/Courses/IS621/Assignment602/Assignment05/Sat/modelmetrics2.csv")
#kable(modselect, caption = "Model Selection KPI")
```
...
We now apply the final model that was trained for predicting the TARGET. Below is a table of predictions.


###Top 10 Records from output 
...
winedata_eval$TARGET <- predict(poismod2, newdata=winedata_eval)

x<-arrange(winedata, (TARGET))
#x<-x[-c(1:2),]
kable(x[1:10,], caption="Model Output / Results")
```
