...
DS_TARGET_FLAG_VALID$TARGET_FLAG2<- as.double(predict(model2_update,newdata=DS_TARGET_FLAG_VALID)[,2])
...
model_comparison[3,c("AUC")]<-c(auc(DS_TARGET_FLAG_VALID$y, DS_TARGET_FLAG_VALID$TARGET_FLAG3))
